...
router.post('/login-page/password', passport.authenticate('local', {
...
router.post('/signup-page', function(req, res, next) {
    ...
    crypto.pbkdf2(req.body.password, salt, 310000, 32, 'sha256', function(err, hashedPassword) {
        ...
        const post = { user_id: user_id, username: req.body.username, hashed_password: hashedPassword, salt: salt, userdata: null };
